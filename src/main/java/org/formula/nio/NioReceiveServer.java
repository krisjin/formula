...
public class NioReceiveServer {
    ...
    //接受文件路径
    private static final String RECEIVE_PATH = "/usr/local/tools";
    private static final int SERVER_BUFFER_SIZE = 10240;
    private static final int SOCKET_SERVER_PORT = 18899;
    ...
    private ByteBuffer buffer = ByteBuffer.allocate(SERVER_BUFFER_SIZE);
    ...
    public void startServer() throws IOException {
        ...
        InetSocketAddress address
                = new InetSocketAddress(SOCKET_SERVER_PORT);
