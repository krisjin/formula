package org.formula.knn.main;

import org.formula.knn.data.BankMarketing;
import org.formula.knn.loader.BankMarketingLoader;
import org.formula.knn.parallel.individual.KnnClassifierParallelIndividual;
...
public class ParallelIndividualMainSort {
    ...
    public static void main(String[] args) {
        ...
        List<BankMarketing> train = loader.load("/usr/local/gitrep/formula/target/classes/data/bank.data");
        System.out.println("Train: " + train.size());
        List<BankMarketing> test = loader.load("/usr/local/gitrep/formula/target/classes/data/bank.test");
